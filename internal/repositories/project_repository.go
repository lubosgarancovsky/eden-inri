...
func (r *ProjectRepository) FindAll(
	...
	items, total, err := helpers.List[models.Project](query, lq)
	if err != nil {
		return nil, 0, err
	}
...
func (r *ProjectRepository) Update(ctx context.Context, prj *models.Project) (*models.Project, error) {
	result := r.db.
		WithContext(ctx).
		Model(&prj).
		Clauses(clause.Returning{}).
...
func (r *ProjectRepository) GetUserRole(ctx context.Context, projectID, userID uuid.UUID) (models.ProjectRole, error) {
