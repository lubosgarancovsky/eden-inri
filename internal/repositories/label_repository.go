...
func (r *LabelRepository) FindAll(ctx context.Context, projectID uuid.UUID, lq *list.ListingQuery) (*[]models.Label, int64, error) {
	query := r.db.
		WithContext(ctx).
		Model(models.Label{}).
	...
	items, total, err := helpers.List[models.Label](query, lq)
	if err != nil {
		return nil, 0, err
	}
...
// FindByID a label
func (r *LabelRepository) FindByID(ctx context.Context, projectID, labelID uuid.UUID) (*models.Label, error) {
...
// Insert a new label
func (r *LabelRepository) Insert(ctx context.Context, label *models.Label) (*models.Label, error) {
	err := r.db.
		WithContext(ctx).
