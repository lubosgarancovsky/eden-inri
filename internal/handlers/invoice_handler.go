...
func NewInvoiceHandler(parser *rsql.Parser, s *services.InvoiceService) *InvoiceHandler {
...
// @Accept       json
// @Produce      json
// @Param        invoice  body  models.InvoiceRequest  true  "Invoice data"
...
// @Accept       json
// @Produce      json
// @Success      200  {object}   models.TotalRevenueResponse
...
func (h *InvoiceHandler) TotalRevenue(c *gin.Context) {
	...
	c.JSON(200, models.TotalRevenueResponse{Total: total})
}
...
// @Accept       json
// @Produce      json
// @Success      200  {object}   models.RevenueGraphResponse
...
func (h *InvoiceHandler) RevenueGraph(c *gin.Context) {
	...
	c.JSON(200, models.RevenueGraphResponse{Points: points})
}
