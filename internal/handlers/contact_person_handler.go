...
type ContactPersonHandler struct {
	s      *services.ContactPersonService
	parser *rsql.Parser
}

type ContactPersonPage struct {
	Items      []models.ContactPerson
	Page       int
	PageSize   int
	TotalCount int64
}

func NewContactPersonHandler(parser *rsql.Parser, s *services.ContactPersonService) *ContactPersonHandler {
...
// @Success      200  {object}   models.ContactPerson
...
// @Produce      json
// @Param        clientId   path      string  true  "Client ID"
// @Param        contactPerson  body  models.ContactPersonRequest  true  "Contact person data"
// @Success      201  {object}  models.ContactPerson
// @Router       /v1/inri/clients/{clientId}/contact-persons [post]
// @security GatewayAuth
func (h *ContactPersonHandler) Create(c *gin.Context) {
	var input models.ContactPersonRequest
