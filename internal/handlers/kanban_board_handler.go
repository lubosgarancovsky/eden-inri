...
type KanbanBoardHandler struct {
	s      *services.KanbanBoardService
	parser *rsql.Parser
}

func NewKanbanBoardHandler(s *services.KanbanBoardService, parser *rsql.Parser) *KanbanBoardHandler {
...
// @Success      200  {array}  models.KanbanBoard
...
// @Success      200  {object}  models.KanbanBoard
