...
type MemberPage struct {
	Items      []models.ProjectUser
	Page       int
	PageSize   int
	TotalCount int64
}

func NewProjectUserHandler(parser *rsql.Parser, s *services.ProjectUserService) *ProjectUserHandler {
...
// @Param        body        body      models.UpdateProjectUserRequest true "New role"
